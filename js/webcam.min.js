    ...
    var Webcam = {
        ...
        attach: function (a) {
            ...
            if (this.userMedia) {
                ...
                n.setAttribute("id", "pose-video");
                n.setAttribute("autoplay", "autoplay");
                n.setAttribute("playsinline", "playsinline");
                n.style.width = "" + this.params.dest_width + "%";
                n.style.height = "" + this.params.dest_height + "%";
                if (r != 1 || o != 1) {
            ...
            if (this.params.crop_width && this.params.crop_height) {
                ...
                a.style.width = "" + this.params.width + "%";
                a.style.height = "" + this.params.height + "%"
            }
        },
        reset: function () {
