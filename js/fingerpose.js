! function (t, e) {
    ...
    return function (t) {
        ...
        T = new S("victory");
        T.addCurl(o.Thumb, a.HalfCurl, .5), T.addCurl(o.Thumb, a.NoCurl, .5), T.addDirection(o.Thumb, l.VerticalUp, 1), T.addDirection(o.Thumb, l.DiagonalUpLeft, 1), 
        T.addCurl(o.Index, a.NoCurl, 1), T.addDirection(o.Index, l.VerticalUp, .75), T.addDirection(o.Index, l.DiagonalUpLeft, 1), T.addDirection(o.Index, l.DiagonalUpRight, 1), 
        T.addCurl(o.Middle, a.NoCurl, 1), T.addDirection(o.Middle, l.VerticalUp, 1), T.addDirection(o.Middle, l.DiagonalUpLeft, .75), T.addDirection(o.Middle, l.DiagonalUpRight, .75), 
        T.addCurl(o.Ring, a.FullCurl, 1), T.addDirection(o.Ring, l.VerticalUp, .2), T.addDirection(o.Ring, l.DiagonalUpLeft, 1), T.addDirection(o.Ring, l.HorizontalLeft, .2), 
        T.addCurl(o.Pinky, a.FullCurl, 1), T.addDirection(o.Pinky, l.VerticalUp, .2), T.addDirection(o.Pinky, l.DiagonalUpLeft, 1), T.addDirection(o.Pinky, l.HorizontalLeft, .2), T.setWeight(o.Index, 2), T.setWeight(o.Middle, 2);
        var C = T,
        
        R = new S("thumbs_up");
        R.addCurl(o.Thumb, a.NoCurl, 1),   R.addCurl(o.Thumb, a.NoCurl, .5),  R.addDirection(o.Thumb, l.VerticalUp, 1), R.addDirection(o.Thumb, l.DiagonalUpLeft, 1), 
        R.addCurl(o.Index, a.NoCurl, 1), R.addDirection(o.Index, l.VerticalUp, .5), R.addDirection(o.Index, l.DiagonalUpLeft, .5), R.addDirection(o.Index, l.DiagonalUpRight, .5), 
        R.addCurl(o.Middle, a.FullCurl, 1), R.addDirection(o.Middle, l.VerticalUp, 1), R.addDirection(o.Middle, l.DiagonalUpLeft, 1), R.addDirection(o.Middle, l.DiagonalUpRight, 1), 
        R.addCurl(o.Ring, a.FullCurl, 1), R.addDirection(o.Ring, l.VerticalUp, 1), R.addDirection(o.Ring, l.DiagonalUpLeft, 1), R.addDirection(o.Ring, l.HorizontalLeft, 1), 
        R.addCurl(o.Pinky, a.NoCurl, 1), R.addDirection(o.Pinky, l.VerticalUp, .5), R.addDirection(o.Pinky, l.DiagonalUpLeft, .5), R.addDirection(o.Pinky, l.HorizontalLeft, .5), R.setWeight(o.Middle, 3), R.setWeight(o.Ring, 3);
        var j = R,
        ...
        X = new S("thumbCurl");
        X.addCurl(o.Thumb, a.HalfCurl, 1), X.addCurl(o.Thumb, a.HalfCurl, .5), X.addDirection(o.Thumb, l.VerticalUp, 1), X.addDirection(o.Thumb, l.DiagonalUpLeft, 1), 
        X.addCurl(o.Index, a.NoCurl, 1), X.addDirection(o.Index, l.VerticalUp, .75), X.addDirection(o.Index, l.DiagonalUpLeft, 1), X.addDirection(o.Index, l.DiagonalUpRight, 1), 
        X.addCurl(o.Middle, a.NoCurl, 1), X.addDirection(o.Middle, l.VerticalUp, 1), X.addDirection(o.Middle, l.DiagonalUpLeft, .75), X.addDirection(o.Middle, l.DiagonalUpRight, .75), 
        X.addCurl(o.Ring, a.NoCurl, 1), X.addDirection(o.Ring, l.VerticalUp, .2), X.addDirection(o.Ring, l.DiagonalUpLeft, 1), X.addDirection(o.Ring, l.HorizontalLeft, .2), 
        X.addCurl(o.Pinky, a.NoCurl, 1), X.addDirection(o.Pinky, l.VerticalUp, .2), X.addDirection(o.Pinky, l.DiagonalUpLeft, 1), X.addDirection(o.Pinky, l.HorizontalLeft, .2), X.setWeight(o.Thumb, 2)
        var z = X;;
